...
const countries = ["Finland", "Sweden", "Norway", "Denmark", "Germany", "Italy", "Turkey"];
...
const countries2 = ["Finland", "Sweden", "Norway", "Denmark", "Germany", "Italy", "Turkey"];
const result = [];
...
const array1 = [true, false, true, false, true, false, true, false, true, false, true, false];
...
class Person {
  ...
  greeting() {
    console.log(`Hello, my name is ${this.name} and I am ${this.age} years old and I am a ${this.role}!`);
  }
}
